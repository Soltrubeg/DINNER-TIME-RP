...
bool applyTextEffects() { 
    ...
    switch(vertexColorId >> 8) { 
        ...
        TEXT_EFFECT( 240, 240, 0 )
        {
            ...
            remove_text_shadow();
            textData.offset += vec2(0,-70);
        }

        // UI ACTIONBAR PRIMARY
        ...
        TEXT_EFFECT( 240, 240, 12 )
        {
            override_text_color( rgb(255, 255, 255) );
            remove_text_shadow();
            textData.offset += vec2(0,-10);
        }
        // UI BOSSBAR SECONDARY
        ...
        {
            override_text_color( rgb(253, 164, 175) );
